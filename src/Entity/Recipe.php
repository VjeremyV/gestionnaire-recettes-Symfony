...
#[UniqueEntity('name', message: 'Le nom de la recette existe déjà')] // permet dee créer des entités uniques par rapport à l'attribut name
...
class Recipe
{
    ...
    #[Assert\LessThan(
        value: 1441,
        message: 'Le temps ne peut pas être supérieur à 1440'
    )]
    ...
    #[Assert\LessThan(
        value: 51,
        message: 'Le nombre de personnes ne peut pas exceder 50'
    )]
    ...
    #[Assert\LessThan(
        value: 6,
        message: 'La note doit être donnée sur 6'
    )]
